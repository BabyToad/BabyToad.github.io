...
`;function He(){if(document.getElementById("mario-jump-styles"))return;const t=document.createElement("style");t.id="mario-jump-styles",t.textContent=Me,document.head.appendChild(t)}function Ge(t){He();const e=t.getContext("2d"),a=Math.max(1,Math.min(3,window.devicePixelRatio||1));let n=0,s=0;function r(){const i=t.getBoundingClientRect();i.width<1||i.height<1||(n=i.width,s=i.height,t.width=Math.round(n*a),t.height=Math.round(s*a))}const p=new ResizeObserver(r);p.observe(t),r();const f=new Image;f.src="img/claude-sprite.png";let x=!1;f.onload=()=>{x=!0};const R=new Image;R.src="img/playground-backdrop.png";let _=!1;R.onload=()=>{_=!0};const v={gravity:.65,jumpStrength:13.5,moveSpeed:5,airControl:1,realisticMode:!1,variableJump:!0,coyoteTime:!0,jumpBuffer:!0,apexHang:!0,asymmetricGravity:!0,fastFall:!0},k={...v},N=["variableJump","coyoteTime","jumpBuffer","apexHang","asymmetricGravity","fastFall"],o={x:80,y:470-G,vx:0,vy:0,facing:1,squash:1},l={onGround:!1,coyote:0,buffer:0,currentGravity:v.gravity,jumpPressedThisFrame:!1,releasedJumpInRise:!1},A={vy:new Float32Array(Y),ay:new Float32Array(Y),y:new Float32Array(Y),head:0};function c(){A.vy[A.head]=o.vy,A.ay[A.head]=l.currentGravity,A.y[A.head]=o.y,A.head=(A.head+1)%Y}function g(){o.x=80,o.y=470-G,o.vx=0,o.vy=0,o.facing=1,o.squash=1,l.onGround=!1,l.coyote=0,l.buffer=0,l.releasedJumpInRise=!1,A.vy.fill(0),A.ay.fill(0),A.y.fill(o.y),A.head=0}const u={left:!1,right:!1,jump:!1,down:!1},C={arrowleft:"left",a:"left",arrowright:"right",d:"right",arrowup:"jump",w:"jump"," ":"jump",arrowdown:"down",s:"down"};let b=!1;function D(i){if(!b)return;const y=i.key.toLowerCase();if(y==="r"&&i.type==="keydown"){g(),i.preventDefault(),i.stopImmediatePropagation();return}const m=C[y];if(!m)return;const T=i.type==="keydown";m==="jump"&&(T&&!u.jump&&(l.jumpPressedThisFrame=!0),!T&&u.jump&&o.vy<0&&(l.releasedJumpInRise=!0)),u[m]=T,i.preventDefault(),i.stopImmediatePropagation()}window.addEventListener("keydown",D,!0),window.addEventListener("keyup",D,!0),t.setAttribute("tabindex","0"),t.style.outline="none";const z=()=>{b=!0,t.style.boxShadow="inset 0 0 0 2px rgba(255,107,53,0.6)"},q=()=>{b=!1,t.style.boxShadow="",u.left=u.right=u.jump=u.down=!1};t.addEventListener("focus",z),t.addEventListener("blur",q);const X=()=>t.focus();t.addEventListener("pointerdown",X);function M(i,y,m){return`<label class="pg-toggle">
