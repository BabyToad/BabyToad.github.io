(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const p of r.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&n(p)}).observe(document,{childList:!0,subtree:!0});function o(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=o(s);fetch(s.href,r)}})();function Fe(t){const e=t.getContext("2d");t.width=t.clientWidth*devicePixelRatio,t.height=t.clientHeight*devicePixelRatio,e.scale(devicePixelRatio,devicePixelRatio);const o=t.clientWidth,n=t.clientHeight;let s=o/2-20,r=n/2-20;const p=5,f={},x=v=>{"wasd".includes(v.key.toLowerCase())&&(f[v.key.toLowerCase()]=v.type==="keydown",v.preventDefault())};window.addEventListener("keydown",x),window.addEventListener("keyup",x);let $;function k(){f.a&&(s-=p),f.d&&(s+=p),f.w&&(r-=p),f.s&&(r+=p),s=Math.max(0,Math.min(s,o-40)),r=Math.max(0,Math.min(r,n-40)),e.fillStyle="#0b0d10",e.fillRect(0,0,o,n),e.fillStyle="#ff6b35",e.fillRect(s,r,40,40),$=requestAnimationFrame(k)}return k(),()=>{cancelAnimationFrame($),window.removeEventListener("keydown",x),window.removeEventListener("keyup",x)}}const W=1200,B=540,le=140,Z=B+le,Q=42,G=54,Ne=7,je=8,We=.35,Oe=2.2,Me=.5,Ue=1.55,De=1.9,H=240,re=[[0,470,340,70],[420,470,200,70],[680,420,160,120],[880,350,100,190],[1040,470,160,70],[920,280,80,16]],qe=`
.playground-wrap {
...
`;function Ye(){if(document.getElementById("mario-jump-styles"))return;const t=document.createElement("style");t.id="mario-jump-styles",t.textContent=qe,document.head.appendChild(t)}function Ge(t){Ye();const e=t.getContext("2d"),o=Math.max(1,Math.min(3,window.devicePixelRatio||1));let n=0,s=0;function r(){const i=t.getBoundingClientRect();i.width<1||i.height<1||(n=i.width,s=i.height,t.width=Math.round(n*o),t.height=Math.round(s*o))}const p=new ResizeObserver(r);p.observe(t),r();const f=new Image;f.src="img/claude-sprite.png";let x=!1;f.onload=()=>{x=!0};const $=new Image;$.src="img/playground-backdrop.png";let k=!1;$.onload=()=>{k=!0};const v={gravity:.65,jumpStrength:13.5,moveSpeed:5,airControl:1,realisticMode:!1,variableJump:!0,coyoteTime:!0,jumpBuffer:!0,apexHang:!0,asymmetricGravity:!0,fastFall:!0},_={...v},F=["variableJump","coyoteTime","jumpBuffer","apexHang","asymmetricGravity","fastFall"],a={x:80,y:470-G,vx:0,vy:0,facing:1,squash:1},l={onGround:!1,coyote:0,buffer:0,currentGravity:v.gravity,jumpPressedThisFrame:!1,releasedJumpInRise:!1},E={vy:new Float32Array(H),ay:new Float32Array(H),y:new Float32Array(H),head:0};function c(){E.vy[E.head]=a.vy,E.ay[E.head]=l.currentGravity,E.y[E.head]=a.y,E.head=(E.head+1)%H}function m(){a.x=80,a.y=470-G,a.vx=0,a.vy=0,a.facing=1,a.squash=1,l.onGround=!1,l.coyote=0,l.buffer=0,l.releasedJumpInRise=!1,E.vy.fill(0),E.ay.fill(0),E.y.fill(a.y),E.head=0}const u={left:!1,right:!1,jump:!1,down:!1},C={arrowleft:"left",a:"left",arrowright:"right",d:"right",arrowup:"jump",w:"jump"," ":"jump",arrowdown:"down",s:"down"};let b=!1;function O(i){if(!b)return;const y=i.key.toLowerCase();if(y==="r"&&i.type==="keydown"){m(),i.preventDefault(),i.stopImmediatePropagation();return}const g=C[y];if(!g)return;const T=i.type==="keydown";g==="jump"&&(T&&!u.jump&&(l.jumpPressedThisFrame=!0),!T&&u.jump&&a.vy<0&&(l.releasedJumpInRise=!0)),u[g]=T,i.preventDefault(),i.stopImmediatePropagation()}window.addEventListener("keydown",O,!0),window.addEventListener("keyup",O,!0),t.setAttribute("tabindex","0"),t.style.outline="none";const K=()=>{b=!0,t.style.boxShadow="inset 0 0 0 2px rgba(255,107,53,0.6)"},D=()=>{b=!1,t.style.boxShadow="",u.left=u.right=u.jump=u.down=!1};t.addEventListener("focus",K),t.addEventListener("blur",D);const X=()=>t.focus();t.addEventListener("pointerdown",X);function q(i,y,g){return`<label class="pg-toggle">
      <input type="checkbox" data-cfg="${i}" ${v[i]?"checked":""} />
      <span class="pg-toggle__label">${y}</span>
      <span class="pg-toggle__desc">${g}</span>
    </label>`}function z(i,y,g,T,S,R=A=>A.toFixed(2)){return`<label class="pg-slider">
      <span class="pg-slider__label">${S}</span>
      <span class="pg-slider__value" data-for="${i}">${R(v[i])}</span>
    ...
    <div class="pg-section">
      ...
      ${z("jumpStrength",5,22,.5,"Jump strength",i=>i.toFixed(1))}
      ${z("moveSpeed",1,10,.5,"Move speed",i=>i.toFixed(1))}
  ...
  `;const Y={vx:L.querySelector("[data-stat=vx]"),vy:L.querySelector("[data-stat=vy]"),ay:L.querySelector("[data-stat=ay]"),ground:L.querySelector("[data-stat=ground]"),coyote:L.querySelector("[data-stat=coyote]"),buffer:L.querySelector("[data-stat=buffer]")};L.querySelectorAll("input[data-cfg]").forEach(i=>{i.addEventListener("input",()=>{const y=i.dataset.cfg;if(i.type==="checkbox"){if(_[y]=i.checked,y==="realisticMode"&&i.checked&&F.forEach(g=>{_[g]=!1;const T=L.querySelector(`input[data-cfg="${g}"]`);T&&(T.checked=!1)}),F.includes(y)&&i.checked&&_.realisticMode){_.realisticMode=!1;const g=L.querySelector('input[data-cfg="realisticMode"]');g&&(g.checked=!1)}}else{const g=parseFloat(i.value);_[y]=g;const T=L.querySelector(`.pg-slider__value[data-for="${y}"]`);T&&(T.textContent=Number.isInteger(g*2)?g.toFixed(1):g.toFixed(2))}})}),L.querySelector(".pg-reset").addEventListener("click",m);const ee=t.closest(".demo__split");ee.classList.add("playground-wrap"),ee.appendChild(L);function he(i,y,g,T,S,R,A,w){return i<S+A&&i+g>S&&y<R+w&&y+T>R}function ie(i,y,g){return i+(y-i)*g}function ke(i){let y=0;u.left&&(y-=_.moveSpeed),u.right&&(y+=_.moveSpeed);const g=l.onGround?1:_.airControl;a.vx=ie(a.vx,y,Math.min(1,.3*g*i)),Math.abs(y)>.2&&(a.facing=Math.sign(y)),l.jumpPressedThisFrame&&(l.buffer=_.jumpBuffer?je:1),l.buffer=Math.max(0,l.buffer-i);const T=l.onGround||_.coyoteTime&&l.coyote>0;l.buffer>0&&T&&(a.vy=-_.jumpStrength,l.buffer=0,l.coyote=0,l.onGround=!1,l.releasedJumpInRise=!1,a.squash=1.2),_.variableJump&&l.releasedJumpInRise&&a.vy<0&&(a.vy*=We,l.releasedJumpInRise=!1),u.jump||(l.releasedJumpInRise=!1);let S=_.gravity;const R=!_.realisticMode;R&&_.apexHang&&Math.abs(a.vy)<Oe&&(S*=Me),R&&_.asymmetricGravity&&a.vy>0&&(S*=Ue),R&&_.fastFall&&u.down&&a.vy>0&&(S*=De),l.currentGravity=S,a.vy+=S*i,a.vy>18&&(a.vy=18),a.x+=a.vx*i;for(const[w,I,P,M]of re)he(a.x,a.y,Q,G,w,I,P,M)&&(a.vx>0?a.x=w-Q:a.vx<0&&(a.x=w+P),a.vx=0);const A=l.onGround;l.onGround=!1,a.y+=a.vy*i;for(const[w,I,P,M]of re)if(he(a.x,a.y,Q,G,w,I,P,M)){if(a.vy>0){if(a.y=I-G,l.onGround=!0,!A){const J=Math.min(1,a.vy/16);a.squash=ie(1,.7,J)}}else a.vy<0&&(a.y=I+M);a.vy=0}A&&!l.onGround&&a.vy>=0?l.coyote=Ne:l.coyote>0&&!l.onGround?l.coyote=Math.max(0,l.coyote-i):l.onGround&&(l.coyote=0),a.squash=ie(a.squash,1,Math.min(1,.2*i)),(a.y>B+200||a.x<-300||a.x>W+300)&&m(),l.jumpPressedThisFrame=!1,c()}let _e=0;function xe(){if(++_e%4!==0)return;const i=y=>y>=0?"+":"";Y.vx.textContent=`${i(a.vx)}${a.vx.toFixed(2)}`,Y.vy.textContent=`${i(a.vy)}${a.vy.toFixed(2)}`,Y.ay.textContent=`${i(l.currentGravity)}${l.currentGravity.toFixed(2)}`,Y.ground.textContent=l.onGround?"yes":"no",Y.ground.className=l.onGround?"good":"muted",Y.coyote.textContent=l.coyote.toFixed(0),Y.coyote.className=l.coyote>0?"accent":"muted",Y.buffer.textContent=l.buffer.toFixed(0),Y.buffer.className=l.buffer>0?"accent":"muted"}function Te(){if(k){const A=$.width/$.height,w=W/B;let I,P,M,J;A>w?(P=B,I=P*A,M=(W-I)/2,J=0):(I=W,P=I/A,M=0,J=(B-P)/2),e.drawImage($,M,J,I,P)}else{const A=e.createLinearGradient(0,0,0,B);A.addColorStop(0,"#0b0d10"),A.addColorStop(1,"#2a1f1a"),e.fillStyle=A,e.fillRect(0,0,W,B)}for(const[A,w,I,P]of re)e.fillStyle="#b78363",e.fillRect(A,w,I,P),e.fillStyle="#f1c591",e.fillRect(A,w,I,5),e.fillStyle="rgba(0,0,0,0.18)",e.fillRect(A+I-3,w,3,P),e.fillStyle="#8a5a3a",e.fillRect(A,w+5,I,2);e.save();const i=a.x+Q/2,y=a.y+G;e.translate(i,y);let g=a.squash,T=1/a.squash;if(!l.onGround){const A=Math.max(-.15,Math.min(.22,-a.vy/80));g*=1+A,T*=1-A*.6}e.scale(T*a.facing,g);const S=Q*2,R=G*2;x?e.drawImage(f,-S/2,-R*.92,S,R):(e.fillStyle="#d97757",e.fillRect(-Q/2,-G,Q,G)),e.restore()}function Ee(){const i=B,y=12,g=3,T=12,S=(W-y*2-T*(g-1))/g,R=le-y*2;e.fillStyle="rgba(11, 13, 16, 0.85)",e.fillRect(0,i,W,le),e.fillStyle="rgba(255,255,255,0.06)",e.fillRect(0,i,W,1),[{label:"y (position)",data:E.y,color:"#6fb3d2",min:0,max:B,invert:!0,zeroLine:!1},{label:"vy (velocity)",data:E.vy,color:"#ff6b35",min:-22,max:22,invert:!1,zeroLine:!0},{label:"ay (accel/grav)",data:E.ay,color:"#98c379",min:0,max:3,invert:!1,zeroLine:!1}].forEach((w,I)=>{const P=y+I*(S+T);if(e.fillStyle="rgba(255,255,255,0.04)",e.fillRect(P,i+y,S,R),e.font="12px ui-monospace, monospace",e.textBaseline="top",e.fillStyle="rgba(255,255,255,0.55)",e.fillText(w.label,P+8,i+y+6),w.zeroLine){const V=i+y+R*((0-w.min)/(w.max-w.min));e.fillStyle="rgba(255,255,255,0.15)",e.fillRect(P,V,S,1)}e.strokeStyle=w.color,e.lineWidth=1.5,e.beginPath();for(let V=0;V<H;V++){const $e=(E.head+V)%H,Re=w.data[$e],Ce=V/(H-1),me=Math.max(0,Math.min(1,(Re-w.min)/(w.max-w.min))),Le=w.invert?me:1-me,ge=P+Ce*S,be=i+y+Le*R;V===0?e.moveTo(ge,be):e.lineTo(ge,be)}e.stroke();const M=(E.head-1+H)%H,J=w.data[M],ye=Math.max(0,Math.min(1,(J-w.min)/(w.max-w.min))),Se=w.invert?ye:1-ye,Pe=P+S-1,Ie=i+y+Se*R;e.fillStyle=w.color,e.beginPath(),e.arc(Pe,Ie,3,0,Math.PI*2),e.fill()})}function Ae(){if(n<1||s<1)return;e.setTransform(1,0,0,1,0,0),e.clearRect(0,0,t.width,t.height);const i=Math.min(n/W,s/Z),y=(n-W*i)/2,g=(s-Z*i)/2,T=i*o;e.setTransform(T,0,0,T,y*o,g*o),e.imageSmoothingEnabled=!1,Te(),Ee(),b||(e.fillStyle="rgba(0,0,0,0.45)",e.fillRect(0,0,W,Z),e.fillStyle="#ffe6d4",e.font="bold 28px ui-monospace, monospace",e.textAlign="center",e.textBaseline="middle",e.fillText("click to play",W/2,Z/2),e.textAlign="start")}let se,pe=performance.now();function ue(i){const y=Math.min(40,i-pe);pe=i;const g=y/(1e3/60);ke(g),xe(),Ae(),se=requestAnimationFrame(ue)}return se=requestAnimationFrame(ue),()=>{cancelAnimationFrame(se),window.removeEventListener("keydown",O,!0),window.removeEventListener("keyup",O,!0),t.removeEventListener("focus",K),t.removeEventListener("blur",D),t.removeEventListener("pointerdown",X),p.disconnect(),L.remove(),ee&&ee.classList.remove("playground-wrap"),t.style.boxShadow=""}}const He={"moving-square":Fe,"mario-jump":Ge};let te=null;function Be(t){if(te&&(te(),te=null),!t)return;const e=t.querySelector(".demo__canvas"),o=t.getAttribute("data-demo");if(!e||!o)return;const n=He[o];if(!n){console.warn(`[demo] unknown demo: ${o}`);return}te=n(e)||null}let ne=null;function Ke(t){if(ne&&(ne(),ne=null),!(t!=null&&t.hasAttribute("data-interactive-code")))return;const e=t.querySelector(".icode");if(!e)return;const o=[...t.querySelectorAll(".icode__line[data-region]")],n=[...t.querySelectorAll(".icode__ann[data-region]")],s=[...t.querySelectorAll(".icode-tip")],r=[...new Set(o.map(c=>c.dataset.region).filter(Boolean))],p=new Set;let f=null,x=null,$=!1,k=null;function v(){const c=f!==null;e.classList.toggle("icode--has-active",c),e.classList.toggle("icode--has-revealed",p.size>0);for(const m of o){const u=m.dataset.region;u&&(m.classList.toggle("icode__line--active",u===f),m.classList.toggle("icode__line--revealed",p.has(u)))}for(const m of n){const u=m.dataset.region;m.classList.toggle("icode__ann--active",u===f),m.classList.toggle("icode__ann--revealed",p.has(u))}}function _(){$||p.size>=r.length&&($=!0,e.classList.add("icode--complete"),setTimeout(()=>e.classList.remove("icode--complete"),900))}v();function F(c){var m,u;if(!((m=c.target)!=null&&m.isContentEditable||/input|textarea/i.test((u=c.target)==null?void 0:u.tagName))){if(c.key>="1"&&c.key<="9"){const C=parseInt(c.key)-1;if(C>=r.length)return;c.preventDefault();const b=r[C];f===b?(f=null,x=null):(p.add(b),f=b,x=b,_()),v();return}if(c.key==="0"||c.key==="Escape"){(f||x)&&(c.preventDefault(),f=null,x=null,v());return}}}addEventListener("keydown",F);const a=[];for(const c of o){const m=c.dataset.region;if(!m)continue;const u=()=>{!x&&p.has(m)&&(f=m,v())},C=()=>{x||(f=null,v())};c.addEventListener("mouseenter",u),c.addEventListener("mouseleave",C),a.push({el:c,events:{mouseenter:u,mouseleave:C}})}for(const c of n){const m=c.dataset.region,u=()=>{!x&&p.has(m)&&(f=m,v())},C=()=>{x||(f=null,v())},b=()=>{x===m?(x=null,f=null):(p.add(m),x=m,f=m,_()),v()};c.addEventListener("mouseenter",u),c.addEventListener("mouseleave",C),c.addEventListener("click",b),a.push({el:c,events:{mouseenter:u,mouseleave:C,click:b}})}function l(c){E();const m=c.dataset.tipSig||"",u=c.dataset.tipDesc||"",C=c.dataset.tipUrl||"";if(!m&&!u)return;const b=document.createElement("div");b.className="icode-tooltip",b.innerHTML=[m?`<code class="icode-tooltip__sig">${de(m)}</code>`:"",u?`<div class="icode-tooltip__desc">${de(u)}</div>`:"",C?`<a class="icode-tooltip__link" href="${de(C)}" target="_blank" rel="noopener">→ docs</a>`:""].filter(Boolean).join(""),e.appendChild(b),e.style.position="relative";let O=0,K=0,D=c;for(;D&&D!==e;)O+=D.offsetTop,K+=D.offsetLeft,D=D.offsetParent;b.style.left=Math.max(0,K)+"px",b.style.visibility="hidden";const X=b.offsetHeight,q=b.offsetWidth;O-X-10<0?(b.style.top=O+c.offsetHeight+8+"px",b.classList.add("icode-tooltip--below")):b.style.top=O-X-8+"px";const z=e.offsetWidth-q-8;parseInt(b.style.left)>z&&(b.style.left=Math.max(0,z)+"px"),b.style.visibility="",k=b}function E(){k&&(k.remove(),k=null)}for(const c of s){const m=()=>l(c),u=()=>E();c.addEventListener("mouseenter",m),c.addEventListener("mouseleave",u),a.push({el:c,events:{mouseenter:m,mouseleave:u}})}ne=()=>{removeEventListener("keydown",F);for(const c of a)for(const[m,u]of Object.entries(c.events))c.el.removeEventListener(m,u);E(),f=null,x=null,e.classList.remove("icode--has-active","icode--has-revealed","icode--complete");for(const c of o)c.classList.remove("icode__line--active","icode__line--revealed");for(const c of n)c.classList.remove("icode__ann--active","icode__ann--revealed")}}function de(t){return(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const ze=localStorage.getItem("deck-theme")||"dark";document.documentElement.setAttribute("data-theme",ze);class Je extends HTMLElement{connectedCallback(){if(this._wired)return;this._wired=!0;const e=document.createElement("div");for(e.className="deck__stage";this.firstChild;)e.appendChild(this.firstChild);this.appendChild(e),this._stage=e,this._collectSlides(),this._buildFooter(),this._buildHelp(),this._index=this._readHashIndex(),this._show(this._index),this._scale(),addEventListener("resize",()=>this._scale()),addEventListener("keydown",o=>this._onKey(o)),addEventListener("hashchange",()=>this._show(this._readHashIndex()))}_collectSlides(){const o=new URLSearchParams(location.search).get("unit");let n=Array.from(this._stage.querySelectorAll(".slide"));o&&(n=n.filter(s=>s.getAttribute("data-unit")===o),this._stage.querySelectorAll(".slide").forEach(s=>{n.includes(s)||s.remove()})),this._slides=n}_buildFooter(){const e=document.createElement("div");e.className="deck__footer",e.innerHTML=`
    ...
    `,document.body.appendChild(e),this._help=e}_readHashIndex(){var n;const e=location.hash.match(/^#(\d+)/);if(!e)return 0;const o=parseInt(e[1],10)-1;return Math.max(0,Math.min(o,(((n=this._slides)==null?void 0:n.length)||1)-1))}_show(e){if(!this._slides.length||e<0||e>=this._slides.length)return;this._index=e;const o=this._slides.length;this._slides.forEach(($,k)=>{k===e?$.setAttribute("data-active",""):$.removeAttribute("data-active")});const n=this._slides[e],s=n.getAttribute("data-unit")||"",r=n.getAttribute("data-tag")||"",p=n.getAttribute("data-total")||"12",f=[];s&&f.push(`UNIT ${s} / ${p}`),r&&f.push(r);const x=f.join("  —  ");this._fTag&&(this._fTag.style.animation="none",this._fTag.offsetHeight,this._fTag.style.animation="",this._fTag.textContent=x),this._fNum&&(this._fNum.textContent=`${String(e+1).padStart(2,"0")} / ${String(o).padStart(2,"0")}`),this._progress&&(this._progress.style.width=`${(e+1)/o*100}%`),location.hash!==`#${e+1}`&&history.replaceState(null,"",`#${e+1}`),Be(n),Ke(n),dispatchEvent(new CustomEvent("deck:slide-change",{detail:{index:e,slide:n}}))}_next(){this._show(Math.min(this._index+1,this._slides.length-1))}_prev(){this._show(Math.max(this._index-1,0))}_onKey(e){if(!(e.target&&e.target.isContentEditable)&&!(e.target&&/input|textarea/i.test(e.target.tagName))){if(e.ctrlKey&&e.shiftKey&&(e.key==="E"||e.key==="e")){e.preventDefault(),dispatchEvent(new CustomEvent("deck:toggle-edit"));return}switch(e.key){case"ArrowRight":case" ":case"PageDown":e.preventDefault(),this._next();break;case"ArrowLeft":case"PageUp":e.preventDefault(),this._prev();break;case"Home":e.preventDefault(),this._show(0);break;case"End":e.preventDefault(),this._show(this._slides.length-1);break;case"f":case"F":document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen();break;case"t":case"T":e.preventDefault(),this._toggleTheme();break;case"?":this._help.toggleAttribute("data-open");break}}}_toggleTheme(){const o=(document.documentElement.getAttribute("data-theme")||"dark")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",o),localStorage.setItem("deck-theme",o)}_scale(){const e=innerWidth,o=innerHeight,n=Math.min(e/1920,o/1080);this._stage.style.transform=`translate(-50%, -50%) scale(${n})`}}customElements.get("deck-root")||customElements.define("deck-root",Je);const Ve=["B","I","EM","STRONG","BR"],Qe=new Set(Ve),Xe=new Set(["BR"]);function d(t){return t==null?"":String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function U(t){if(t==null)return"";const e=document.createElement("template");return e.innerHTML=String(t),ce(e.content)}function ce(t){let e="";for(const o of t.childNodes)if(o.nodeType===Node.TEXT_NODE)e+=d(o.nodeValue);else if(o.nodeType===Node.ELEMENT_NODE){const n=o.tagName;if(Qe.has(n)){const s=n.toLowerCase();Xe.has(n)?e+=`<${s}>`:e+=`<${s}>${ce(o)}</${s}>`}else e+=ce(o)}return e}const Ze=new Set(["False","None","True","and","as","assert","async","await","break","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","in","is","lambda","nonlocal","not","or","pass","raise","return","try","while","with","yield"]),et=new Set(["print","len","range","str","int","float","list","dict","set","tuple","bool","type","isinstance","abs","min","max","sum","enumerate","zip","map","filter","input","open","round","self","cls"]),fe=new RegExp(["(?<comment>#[^\\n]*)",`(?<tstring>"""[\\s\\S]*?"""|'''[\\s\\S]*?''')`,`(?<fstring>f"(?:[^"\\\\\\n]|\\\\.)*"|f'(?:[^'\\\\\\n]|\\\\.)*')`,`(?<string>"(?:[^"\\\\\\n]|\\\\.)*"|'(?:[^'\\\\\\n]|\\\\.)*')`,"(?<decorator>@\\w+)","(?<number>\\b\\d+(?:\\.\\d+)?\\b)","(?<word>[A-Za-z_]\\w*)"].join("|"),"g");function N(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function oe(t){if(t==null)return"";let e="",o=0,n=null,s;for(fe.lastIndex=0;(s=fe.exec(t))!==null;){if(s.index>o){const p=t.slice(o,s.index);e+=N(p),/\S/.test(p)&&(n=null)}const r=s.groups;if(r.comment)e+=`<span class="tok-comment">${N(r.comment)}</span>`,n=null;else if(r.tstring)e+=`<span class="tok-string">${N(r.tstring)}</span>`,n=null;else if(r.fstring)e+=`<span class="tok-string">${N(r.fstring)}</span>`,n=null;else if(r.string)e+=`<span class="tok-string">${N(r.string)}</span>`,n=null;else if(r.decorator)e+=`<span class="tok-decorator">${N(r.decorator)}</span>`,n=null;else if(r.number)e+=`<span class="tok-number">${N(r.number)}</span>`,n=null;else if(r.word){const p=r.word;n==="function"?(e+=`<span class="tok-function-def">${N(p)}</span>`,n=null):n==="class"?(e+=`<span class="tok-class-def">${N(p)}</span>`,n=null):Ze.has(p)?(e+=`<span class="tok-keyword">${N(p)}</span>`,p==="def"?n="function":p==="class"?n="class":n=null):et.has(p)?(e+=`<span class="tok-builtin">${N(p)}</span>`,n=null):(e+=N(p),n=null)}o=s.index+s[0].length}return o<t.length&&(e+=N(t.slice(o))),e}function we(t){const e=(t||"").split(`
`).length;return e>=20?"xs":e>=14?"sm":e>=10?"md":"lg"}function tt(t,e){return e.map(o=>nt(o,t)).join(`
`)}function nt(t,e){const o=ot[t.type];return o?o(t,e):`<div class="slide"><div class="slide__body">Unknown slide type: ${d(t.type)}</div></div>`}function h(t,e,o){return`data-edit="${t}/${e}/${o}"`}function ae(t,e,o){return`data-edit-list="${t}/${e}/${o}"`}function j(t,e,o="",n=""){return`<div class="slide ${o}" data-slide-type="${d(t.type)}" data-edit-slide="${d(e.id)}/${d(t.id)}" data-unit="${d(e.id)}" data-tag="${d(e.tag||"")}" data-total="${d(e.total||"")}"${n?" "+n:""}>`}const ot={section(t,e){return`${j(t,e,"slide--section")}
    ...
    </div>`},title(t,e){return`${j(t,e,"slide--title")}
      <div class="slide__body">
    ...
    </div>`},bullets(t,e){const o=(t.items||[]).map((n,s)=>`<li ${h(e.id,t.id,`items[${s}]`)}>${U(n)}</li>`).join("");return`${j(t,e,"slide--bullets")}
      <div class="slide__body">
        <div class="bullets">
          ...
          <ul class="bullets__list" ${ae(e.id,t.id,"items")}>${o}</ul>
        </div>
      </div>
    </div>`},question(t,e){return`${j(t,e,"slide--question")}
      <div class="slide__body">
        <div class="qslide">
        ...
        <ul ${ae(e.id,t.id,`${n}.items`)}>${r}</ul>
      </div>`};return`${j(t,e,"slide--split")}
      <div class="slide__body">
        <div class="split">
    ...
    </div>`},prose(t,e){return`${j(t,e,"slide--prose")}
      <div class="slide__body">
        <div class="prose">
    ...
    </div>`},concept(t,e){const o=t.diagram||"";return`${j(t,e,"slide--concept")}
      <div class="slide__body">
        <div class="concept">
    ...
    </div>`},image(t,e){const o=t.fit==="contain"?"contain":"cover",n=d(t.src||""),s=d(t.alt||"");return`${j(t,e,"slide--image")}
      <div class="slide__body">
...
`).length:0;return`${j(t,e,`slide--demo${n?" slide--demo-with-code":""}`,`data-demo="${o}"`)}
      <div class="slide__body">
        <div class="demo">
    ...
    </div>`},code(t,e){const o=(t.language||"python").toLowerCase(),n=o==="python"?oe(t.code||""):d(t.code||""),s=we(t.code||"");return`${j(t,e,`slide--code slide--code-${s}`)}
      <div class="slide__body">
    ...
    </div>`},"interactive-code"(t,e){const o=t.regions||[],n=t.tooltips||{},s=/^(\s*)#\s*-{3,}\s*.+\s*-{3,}\s*$/,r={};for(const k of o)for(let v=k.lines[0];v<=k.lines[1];v++)r[v]=k;const p=Object.keys(n).sort((k,v)=>v.length-k.length),x=(t.code||"").split(`
`).map((k,v)=>{const _=v+1,F=r[_];let a=oe(k)||" ";for(const u of p){const C=u.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),b=n[u],K=typeof b=="object"?`data-tip-sig="${d(b.sig||"")}" data-tip-desc="${d(b.desc||"")}" data-tip-url="${d(b.url||"")}"`:`data-tip-sig="" data-tip-desc="${d(b)}" data-tip-url=""`;a=a.replace(new RegExp(C),`<span class="icode-tip" ${K}>${u}</span>`)}const l=F?F.id:"",E=F?F.color:"transparent";return`<div class="${`icode__line${s.test(k)?" icode__line--divider":""}`}" data-region="${l}" data-line="${_}" style="--rc:${E}"><span class="icode__line-num">${_}</span>${a}</div>`}).join(""),$=o.map((k,v)=>{const _=(k.links||[]).map(F=>`<a href="${d(F.url)}" target="_blank" rel="noopener">→ ${d(F.label)}</a>`).join(" ");return`
      <div class="icode__ann" data-region="${d(k.id)}" style="--rc:${d(k.color)}">
        <div class="icode__ann-inner">
          <div class="icode__ann-header">
            <div class="icode__ann-dot"></div>
            <div class="icode__ann-label">${d(k.label)}</div>
            <div class="icode__ann-key">${v+1}</div>
          </div>
          <div class="icode__ann-body">
            <div class="icode__ann-desc">${d(k.description)}</div>
            <div class="icode__ann-detail">${d(k.detail||"")}${_?`<div class="icode__ann-links">${_}</div>`:""}</div>
          </div>
        </div>
      </div>`}).join("");return`${j(t,e,"slide--interactive-code","data-interactive-code")}
      <div class="slide__body">
        <div class="icode">
    ...
    </div>`},"annotated-code"(t,e){const o=oe(t.code||""),n=we(t.code||""),s=(t.annotations||[]).map((r,p)=>`<li ${h(e.id,t.id,`annotations[${p}]`)}>${U(r)}</li>`).join("");return`${j(t,e,`slide--annotated-code slide--acode-${n}`)}
      <div class="slide__body">
        <div class="acode">
          ...
          <div class="acode__cols">
            ...
            <ol class="acode__annotations" ${ae(e.id,t.id,"annotations")}>${s}</ol>
          </div>
          ${t.subtitle?`<div class="acode__subtitle" ${h(e.id,t.id,"subtitle")}>${d(t.subtitle)}</div>`:""}
        </div>
      </div>
    </div>`},live(t,e){const o=(t.items||[]).map((n,s)=>`<li ${h(e.id,t.id,`items[${s}]`)}>${U(n)}</li>`).join("");return`${j(t,e,"slide--live")}
      <div class="slide__body">
        <div class="live">
          <div class="live__badge">● LIVE</div>
          <h2 class="live__heading" ${h(e.id,t.id,"heading")}>${d(t.heading||"")}</h2>
          <ol class="live__list" ${ae(e.id,t.id,"items")}>${o}</ol>
        </div>
      </div>
    </div>`}},at={id:"01",number:"01",tag:"OPENING THE BOX",total:"12"},it=[{id:"section",type:"section",number:"01",kicker:"Unit",title:"Opening the Box"},{id:"welcome",type:"title",eyebrow:"Game Programmierung  ·  SS26",title:"Welcome.",subtitle:"Twelve weeks to build a real game without an engine. Let's take a look under the hood."},{id:"how-it-works",type:"bullets",heading:"What to expect.",lead:"This is how the course will work:",items:["<b>Bring your laptop</b> — Python, Git, and your codebase. Every session.","<b>Short input, long workshop.</b>","<b>Find a partner / rubberduck.</b>","<b>Four exercises.</b> Mandatory part of your grade.","<b>Ask early.</b>"]},{id:"why-question",type:"question",eyebrow:"Question for the room",question:"Why would anyone write a game without an engine"},{id:"why-answer",type:"image",src:"/img/shoggoth.avif",alt:"The Shoggoth — a lovecraftian mass of eyes and tentacles",caption:"To understand the Shoggoth.",fit:"contain"},{id:"today",type:"demo",eyebrow:"TODAY",heading:"A program where you move a shape when you press a button.",demo:"moving-square",hint:"WASD to move",code:`import pygame
pygame.init()
