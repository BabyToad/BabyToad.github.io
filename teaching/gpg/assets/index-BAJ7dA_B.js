...
`;function Ye(){if(document.getElementById("mario-jump-styles"))return;const t=document.createElement("style");t.id="mario-jump-styles",t.textContent=qe,document.head.appendChild(t)}function He(t){Ye();const e=t.getContext("2d"),a=Math.max(1,Math.min(3,window.devicePixelRatio||1));let n=0,s=0;function r(){const i=t.getBoundingClientRect();i.width<1||i.height<1||(n=i.width,s=i.height,t.width=Math.round(n*a),t.height=Math.round(s*a))}const p=new ResizeObserver(r);p.observe(t),r();const f=new Image;f.src="img/claude-sprite.png";let x=!1;f.onload=()=>{x=!0};const R=new Image;R.src="img/playground-backdrop.png";let _=!1;R.onload=()=>{_=!0};const v={gravity:.65,jumpStrength:13.5,moveSpeed:5,airControl:1,realisticMode:!1,variableJump:!0,coyoteTime:!0,jumpBuffer:!0,apexHang:!0,asymmetricGravity:!0,fastFall:!0},k={...v},N=["variableJump","coyoteTime","jumpBuffer","apexHang","asymmetricGravity","fastFall"],o={x:80,y:470-H,vx:0,vy:0,facing:1,squash:1},l={onGround:!1,coyote:0,buffer:0,currentGravity:v.gravity,jumpPressedThisFrame:!1,releasedJumpInRise:!1},A={vy:new Float32Array(G),ay:new Float32Array(G),y:new Float32Array(G),head:0};function c(){A.vy[A.head]=o.vy,A.ay[A.head]=l.currentGravity,A.y[A.head]=o.y,A.head=(A.head+1)%G}function m(){o.x=80,o.y=470-H,o.vx=0,o.vy=0,o.facing=1,o.squash=1,l.onGround=!1,l.coyote=0,l.buffer=0,l.releasedJumpInRise=!1,A.vy.fill(0),A.ay.fill(0),A.y.fill(o.y),A.head=0}const u={left:!1,right:!1,jump:!1,down:!1},C={arrowleft:"left",a:"left",arrowright:"right",d:"right",arrowup:"jump",w:"jump"," ":"jump",arrowdown:"down",s:"down"};let b=!1;function j(i){if(!b)return;const y=i.key.toLowerCase();if(y==="r"&&i.type==="keydown"){m(),i.preventDefault(),i.stopImmediatePropagation();return}const g=C[y];if(!g)return;const T=i.type==="keydown";g==="jump"&&(T&&!u.jump&&(l.jumpPressedThisFrame=!0),!T&&u.jump&&o.vy<0&&(l.releasedJumpInRise=!0)),u[g]=T,i.preventDefault(),i.stopImmediatePropagation()}window.addEventListener("keydown",j,!0),window.addEventListener("keyup",j,!0),t.setAttribute("tabindex","0"),t.style.outline="none";const z=()=>{b=!0,t.style.boxShadow="inset 0 0 0 2px rgba(255,107,53,0.6)"},D=()=>{b=!1,t.style.boxShadow="",u.left=u.right=u.jump=u.down=!1};t.addEventListener("focus",z),t.addEventListener("blur",D);const X=()=>t.focus();t.addEventListener("pointerdown",X);function q(i,y,g){return`<label class="pg-toggle">
      <input type="checkbox" data-cfg="${i}" ${v[i]?"checked":""} />
      <span class="pg-toggle__label">${y}</span>
      <span class="pg-toggle__desc">${g}</span>
    </label>`}function K(i,y,g,T,S,$=E=>E.toFixed(2)){return`<label class="pg-slider">
      <span class="pg-slider__label">${S}</span>
      <span class="pg-slider__value" data-for="${i}">${$(v[i])}</span>
      <input type="range" data-cfg="${i}" min="${y}" max="${g}" step="${T}" value="${v[i]}" />
  ...
  `;const Y={vx:L.querySelector("[data-stat=vx]"),vy:L.querySelector("[data-stat=vy]"),ay:L.querySelector("[data-stat=ay]"),ground:L.querySelector("[data-stat=ground]"),coyote:L.querySelector("[data-stat=coyote]"),buffer:L.querySelector("[data-stat=buffer]")};L.querySelectorAll("input[data-cfg]").forEach(i=>{i.addEventListener("input",()=>{const y=i.dataset.cfg;if(i.type==="checkbox"){if(k[y]=i.checked,y==="realisticMode"&&i.checked&&N.forEach(g=>{k[g]=!1;const T=L.querySelector(`input[data-cfg="${g}"]`);T&&(T.checked=!1)}),N.includes(y)&&i.checked&&k.realisticMode){k.realisticMode=!1;const g=L.querySelector('input[data-cfg="realisticMode"]');g&&(g.checked=!1)}}else{const g=parseFloat(i.value);k[y]=g;const T=L.querySelector(`.pg-slider__value[data-for="${y}"]`);T&&(T.textContent=Number.isInteger(g*2)?g.toFixed(1):g.toFixed(2))}})}),L.querySelector(".pg-reset").addEventListener("click",m);const ee=t.closest(".demo__split");ee.classList.add("playground-wrap"),ee.appendChild(L);function he(i,y,g,T,S,$,E,w){return i<S+E&&i+g>S&&y<$+w&&y+T>$}function ie(i,y,g){return i+(y-i)*g}function _e(i){let y=0;u.left&&(y-=k.moveSpeed),u.right&&(y+=k.moveSpeed);const g=l.onGround?1:k.airControl;o.vx=ie(o.vx,y,Math.min(1,.3*g*i)),Math.abs(y)>.2&&(o.facing=Math.sign(y)),l.jumpPressedThisFrame&&(l.buffer=k.jumpBuffer?Oe:1),l.buffer=Math.max(0,l.buffer-i);const T=l.onGround||k.coyoteTime&&l.coyote>0;l.buffer>0&&T&&(o.vy=-k.jumpStrength,l.buffer=0,l.coyote=0,l.onGround=!1,l.releasedJumpInRise=!1,o.squash=1.2),k.variableJump&&l.releasedJumpInRise&&o.vy<0&&(o.vy*=We,l.releasedJumpInRise=!1),u.jump||(l.releasedJumpInRise=!1);let S=k.gravity;const $=!k.realisticMode;$&&k.apexHang&&Math.abs(o.vy)<je&&(S*=Ue),$&&k.asymmetricGravity&&o.vy>0&&(S*=Me),$&&k.fastFall&&u.down&&o.vy>0&&(S*=De),l.currentGravity=S,o.vy+=S*i,o.vy>18&&(o.vy=18),o.x+=o.vx*i;for(const[w,I,P,U]of re)he(o.x,o.y,Q,H,w,I,P,U)&&(o.vx>0?o.x=w-Q:o.vx<0&&(o.x=w+P),o.vx=0);const E=l.onGround;l.onGround=!1,o.y+=o.vy*i;for(const[w,I,P,U]of re)if(he(o.x,o.y,Q,H,w,I,P,U)){if(o.vy>0){if(o.y=I-H,l.onGround=!0,!E){const J=Math.min(1,o.vy/16);o.squash=ie(1,.7,J)}}else o.vy<0&&(o.y=I+U);o.vy=0}E&&!l.onGround&&o.vy>=0?l.coyote=Fe:l.coyote>0&&!l.onGround?l.coyote=Math.max(0,l.coyote-i):l.onGround&&(l.coyote=0),o.squash=ie(o.squash,1,Math.min(1,.2*i)),(o.y>B+200||o.x<-300||o.x>W+300)&&m(),l.jumpPressedThisFrame=!1,c()}let ke=0;function xe(){if(++ke%4!==0)return;const i=y=>y>=0?"+":"";Y.vx.textContent=`${i(o.vx)}${o.vx.toFixed(2)}`,Y.vy.textContent=`${i(o.vy)}${o.vy.toFixed(2)}`,Y.ay.textContent=`${i(l.currentGravity)}${l.currentGravity.toFixed(2)}`,Y.ground.textContent=l.onGround?"yes":"no",Y.ground.className=l.onGround?"good":"muted",Y.coyote.textContent=l.coyote.toFixed(0),Y.coyote.className=l.coyote>0?"accent":"muted",Y.buffer.textContent=l.buffer.toFixed(0),Y.buffer.className=l.buffer>0?"accent":"muted"}function Te(){if(_){const E=R.width/R.height,w=W/B;let I,P,U,J;E>w?(P=B,I=P*E,U=(W-I)/2,J=0):(I=W,P=I/E,U=0,J=(B-P)/2),e.drawImage(R,U,J,I,P)}else{const E=e.createLinearGradient(0,0,0,B);E.addColorStop(0,"#0b0d10"),E.addColorStop(1,"#2a1f1a"),e.fillStyle=E,e.fillRect(0,0,W,B)}for(const[E,w,I,P]of re)e.fillStyle="#b78363",e.fillRect(E,w,I,P),e.fillStyle="#f1c591",e.fillRect(E,w,I,5),e.fillStyle="rgba(0,0,0,0.18)",e.fillRect(E+I-3,w,3,P),e.fillStyle="#8a5a3a",e.fillRect(E,w+5,I,2);e.save();const i=o.x+Q/2,y=o.y+H;e.translate(i,y);let g=o.squash,T=1/o.squash;if(!l.onGround){const E=Math.max(-.15,Math.min(.22,-o.vy/80));g*=1+E,T*=1-E*.6}e.scale(T*o.facing,g);const S=Q*2,$=H*2;x?e.drawImage(f,-S/2,-$*.92,S,$):(e.fillStyle="#d97757",e.fillRect(-Q/2,-H,Q,H)),e.restore()}function Ae(){const i=B,y=12,g=3,T=12,S=(W-y*2-T*(g-1))/g,$=le-y*2;e.fillStyle="rgba(11, 13, 16, 0.85)",e.fillRect(0,i,W,le),e.fillStyle="rgba(255,255,255,0.06)",e.fillRect(0,i,W,1),[{label:"y (position)",data:A.y,color:"#6fb3d2",min:0,max:B,invert:!0,zeroLine:!1},{label:"vy (velocity)",data:A.vy,color:"#ff6b35",min:-22,max:22,invert:!1,zeroLine:!0},{label:"ay (accel/grav)",data:A.ay,color:"#98c379",min:0,max:3,invert:!1,zeroLine:!1}].forEach((w,I)=>{const P=y+I*(S+T);if(e.fillStyle="rgba(255,255,255,0.04)",e.fillRect(P,i+y,S,$),e.font="12px ui-monospace, monospace",e.textBaseline="top",e.fillStyle="rgba(255,255,255,0.55)",e.fillText(w.label,P+8,i+y+6),w.zeroLine){const V=i+y+$*((0-w.min)/(w.max-w.min));e.fillStyle="rgba(255,255,255,0.15)",e.fillRect(P,V,S,1)}e.strokeStyle=w.color,e.lineWidth=1.5,e.beginPath();for(let V=0;V<G;V++){const Re=(A.head+V)%G,$e=w.data[Re],Ce=V/(G-1),me=Math.max(0,Math.min(1,($e-w.min)/(w.max-w.min))),Le=w.invert?me:1-me,ge=P+Ce*S,be=i+y+Le*$;V===0?e.moveTo(ge,be):e.lineTo(ge,be)}e.stroke();const U=(A.head-1+G)%G,J=w.data[U],ye=Math.max(0,Math.min(1,(J-w.min)/(w.max-w.min))),Se=w.invert?ye:1-ye,Pe=P+S-1,Ie=i+y+Se*$;e.fillStyle=w.color,e.beginPath(),e.arc(Pe,Ie,3,0,Math.PI*2),e.fill()})}function Ee(){if(n<1||s<1)return;e.setTransform(1,0,0,1,0,0),e.clearRect(0,0,t.width,t.height);const i=Math.min(n/W,s/Z),y=(n-W*i)/2,g=(s-Z*i)/2,T=i*a;e.setTransform(T,0,0,T,y*a,g*a),e.imageSmoothingEnabled=!1,Te(),Ae(),b||(e.fillStyle="rgba(0,0,0,0.45)",e.fillRect(0,0,W,Z),e.fillStyle="#ffe6d4",e.font="bold 28px ui-monospace, monospace",e.textAlign="center",e.textBaseline="middle",e.fillText("click to play",W/2,Z/2),e.textAlign="start")}let se,pe=performance.now();function ue(i){const y=Math.min(40,i-pe);pe=i;const g=y/(1e3/60);_e(g),xe(),Ee(),se=requestAnimationFrame(ue)}return se=requestAnimationFrame(ue),()=>{cancelAnimationFrame(se),window.removeEventListener("keydown",j,!0),window.removeEventListener("keyup",j,!0),t.removeEventListener("focus",z),t.removeEventListener("blur",D),t.removeEventListener("pointerdown",X),p.disconnect(),L.remove(),ee&&ee.classList.remove("playground-wrap"),t.style.boxShadow=""}}const Ge={"moving-square":Ne,"mario-jump":He};let te=null;function Be(t){if(te&&(te(),te=null),!t)return;const e=t.querySelector(".demo__canvas"),a=t.getAttribute("data-demo");if(!e||!a)return;const n=Ge[a];if(!n){console.warn(`[demo] unknown demo: ${a}`);return}te=n(e)||null}let ne=null;function ze(t){if(ne&&(ne(),ne=null),!(t!=null&&t.hasAttribute("data-interactive-code")))return;const e=t.querySelector(".icode");if(!e)return;const a=[...t.querySelectorAll(".icode__line[data-region]")],n=[...t.querySelectorAll(".icode__ann[data-region]")],s=[...t.querySelectorAll(".icode-tip")],r=[...new Set(a.map(c=>c.dataset.region).filter(Boolean))],p=new Set;let f=null,x=null,R=!1,_=null;function v(){const c=f!==null;e.classList.toggle("icode--has-active",c),e.classList.toggle("icode--has-revealed",p.size>0);for(const m of a){const u=m.dataset.region;u&&(m.classList.toggle("icode__line--active",u===f),m.classList.toggle("icode__line--revealed",p.has(u)))}for(const m of n){const u=m.dataset.region;m.classList.toggle("icode__ann--active",u===f),m.classList.toggle("icode__ann--revealed",p.has(u))}}function k(){R||p.size>=r.length&&(R=!0,e.classList.add("icode--complete"),setTimeout(()=>e.classList.remove("icode--complete"),900))}v();function N(c){var m,u;if(!((m=c.target)!=null&&m.isContentEditable||/input|textarea/i.test((u=c.target)==null?void 0:u.tagName))){if(c.key>="1"&&c.key<="9"){const C=parseInt(c.key)-1;if(C>=r.length)return;c.preventDefault();const b=r[C];f===b?(f=null,x=null):(p.add(b),f=b,x=b,k()),v();return}if(c.key==="0"||c.key==="Escape"){(f||x)&&(c.preventDefault(),f=null,x=null,v());return}}}addEventListener("keydown",N);const o=[];for(const c of a){const m=c.dataset.region;if(!m)continue;const u=()=>{!x&&p.has(m)&&(f=m,v())},C=()=>{x||(f=null,v())};c.addEventListener("mouseenter",u),c.addEventListener("mouseleave",C),o.push({el:c,events:{mouseenter:u,mouseleave:C}})}for(const c of n){const m=c.dataset.region,u=()=>{!x&&p.has(m)&&(f=m,v())},C=()=>{x||(f=null,v())},b=()=>{x===m?(x=null,f=null):(p.add(m),x=m,f=m,k()),v()};c.addEventListener("mouseenter",u),c.addEventListener("mouseleave",C),c.addEventListener("click",b),o.push({el:c,events:{mouseenter:u,mouseleave:C,click:b}})}function l(c){A();const m=c.dataset.tipSig||"",u=c.dataset.tipDesc||"",C=c.dataset.tipUrl||"";if(!m&&!u)return;const b=document.createElement("div");b.className="icode-tooltip",b.innerHTML=[m?`<code class="icode-tooltip__sig">${de(m)}</code>`:"",u?`<div class="icode-tooltip__desc">${de(u)}</div>`:"",C?`<a class="icode-tooltip__link" href="${de(C)}" target="_blank" rel="noopener">→ docs</a>`:""].filter(Boolean).join(""),e.appendChild(b),e.style.position="relative";let j=0,z=0,D=c;for(;D&&D!==e;)j+=D.offsetTop,z+=D.offsetLeft,D=D.offsetParent;b.style.left=Math.max(0,z)+"px",b.style.visibility="hidden";const X=b.offsetHeight,q=b.offsetWidth;j-X-10<0?(b.style.top=j+c.offsetHeight+8+"px",b.classList.add("icode-tooltip--below")):b.style.top=j-X-8+"px";const K=e.offsetWidth-q-8;parseInt(b.style.left)>K&&(b.style.left=Math.max(0,K)+"px"),b.style.visibility="",_=b}function A(){_&&(_.remove(),_=null)}for(const c of s){const m=()=>l(c),u=()=>A();c.addEventListener("mouseenter",m),c.addEventListener("mouseleave",u),o.push({el:c,events:{mouseenter:m,mouseleave:u}})}ne=()=>{removeEventListener("keydown",N);for(const c of o)for(const[m,u]of Object.entries(c.events))c.el.removeEventListener(m,u);A(),f=null,x=null,e.classList.remove("icode--has-active","icode--has-revealed","icode--complete");for(const c of a)c.classList.remove("icode__line--active","icode__line--revealed");for(const c of n)c.classList.remove("icode__ann--active","icode__ann--revealed")}}function de(t){return(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Ke=localStorage.getItem("deck-theme")||"dark";document.documentElement.setAttribute("data-theme",Ke);class Je extends HTMLElement{connectedCallback(){if(this._wired)return;this._wired=!0;const e=document.createElement("div");for(e.className="deck__stage";this.firstChild;)e.appendChild(this.firstChild);this.appendChild(e),this._stage=e,this._collectSlides(),this._buildFooter(),this._buildHelp(),this._index=this._readHashIndex(),this._show(this._index),this._scale(),addEventListener("resize",()=>this._scale()),addEventListener("keydown",a=>this._onKey(a)),addEventListener("hashchange",()=>this._show(this._readHashIndex()))}_collectSlides(){const a=new URLSearchParams(location.search).get("unit");let n=Array.from(this._stage.querySelectorAll(".slide"));a&&(n=n.filter(s=>s.getAttribute("data-unit")===a),this._stage.querySelectorAll(".slide").forEach(s=>{n.includes(s)||s.remove()})),this._slides=n}_buildFooter(){const e=document.createElement("div");e.className="deck__footer",e.innerHTML=`
...
`)}function nt(t,e){const a=at[t.type];return a?a(t,e):`<div class="slide"><div class="slide__body">Unknown slide type: ${d(t.type)}</div></div>`}function h(t,e,a){return`data-edit="${t}/${e}/${a}"`}function oe(t,e,a){return`data-edit-list="${t}/${e}/${a}"`}function O(t,e,a="",n=""){return`<div class="slide ${a}" data-slide-type="${d(t.type)}" data-edit-slide="${d(e.id)}/${d(t.id)}" data-unit="${d(e.id)}" data-tag="${d(e.tag||"")}" data-total="${d(e.total||"")}"${n?" "+n:""}>`}const at={section(t,e){return`${O(t,e,"slide--section")}
    ...
    </div>`},bullets(t,e){const a=(t.items||[]).map((n,s)=>`<li ${h(e.id,t.id,`items[${s}]`)}>${M(n)}</li>`).join("");return`${O(t,e,"slide--bullets")}
      <div class="slide__body">
        <div class="bullets">
          <h2 class="bullets__heading" ${h(e.id,t.id,"heading")}>${d(t.heading||"")}</h2>
          ${t.lead?`<p class="bullets__lead" ${h(e.id,t.id,"lead")}>${M(t.lead)}</p>`:`<p class="bullets__lead bullets__lead--empty" ${h(e.id,t.id,"lead")}></p>`}
    ...
    </div>`},split(t,e){const a=n=>{const s=t[n]||{title:"",items:[]},r=(s.items||[]).map((p,f)=>`<li ${h(e.id,t.id,`${n}.items[${f}]`)}>${M(p)}</li>`).join("");return`<div class="split__col">
      ...
      <div class="slide__body">
        <div class="prose">
          ...
          <p class="prose__body" ${h(e.id,t.id,"body")}>${M(t.body||"")}</p>
        </div>
      </div>
    </div>`},concept(t,e){const a=t.diagram||"";return`${O(t,e,"slide--concept")}
      <div class="slide__body">
        <div class="concept">
          ${t.eyebrow?`<div class="concept__eyebrow" ${h(e.id,t.id,"eyebrow")}>${d(t.eyebrow)}</div>`:""}
          <h2 class="concept__statement" ${h(e.id,t.id,"statement")}>${M(t.statement||"")}</h2>
          <div class="concept__diagram">${a}</div>
          ${t.caption?`<div class="concept__caption" ${h(e.id,t.id,"caption")}>${M(t.caption)}</div>`:""}
        </div>
      </div>
    </div>`},image(t,e){const a=t.fit==="contain"?"contain":"cover",n=d(t.src||""),s=d(t.alt||"");return`${O(t,e,"slide--image")}
      <div class="slide__body">
        <div class="image-slide image-slide--${a}">
          <img src="${n}" alt="${s}" />
          ${t.caption?`<div class="image-slide__caption" ${h(e.id,t.id,"caption")}>${M(t.caption)}</div>`:`<div class="image-slide__caption image-slide__caption--empty" ${h(e.id,t.id,"caption")}></div>`}
        </div>
      </div>
    </div>`},demo(t,e){const a=d(t.demo||""),n=!!t.code,s=n?ae(t.code):"",r=n?t.code.split(`
`).length:0;return`${O(t,e,`slide--demo${n?" slide--demo-with-code":""}`,`data-demo="${a}"`)}
      <div class="slide__body">
        <div class="demo">
    ...
    </div>`},code(t,e){const a=(t.language||"python").toLowerCase(),n=a==="python"?ae(t.code||""):d(t.code||""),s=we(t.code||"");return`${O(t,e,`slide--code slide--code-${s}`)}
      <div class="slide__body">
        <div class="code-slide">
          ...
          ${t.caption?`<div class="code-slide__caption" ${h(e.id,t.id,"caption")}>${M(t.caption)}</div>`:`<div class="code-slide__caption code-slide__caption--empty" ${h(e.id,t.id,"caption")}></div>`}
        </div>
      </div>
...
`).map((_,v)=>{const k=v+1,N=r[k];let o=ae(_)||" ";for(const u of p){const C=u.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),b=n[u],z=typeof b=="object"?`data-tip-sig="${d(b.sig||"")}" data-tip-desc="${d(b.desc||"")}" data-tip-url="${d(b.url||"")}"`:`data-tip-sig="" data-tip-desc="${d(b)}" data-tip-url=""`;o=o.replace(new RegExp(C),`<span class="icode-tip" ${z}>${u}</span>`)}const l=N?N.id:"",A=N?N.color:"transparent";return`<div class="${`icode__line${s.test(_)?" icode__line--divider":""}`}" data-region="${l}" data-line="${k}" style="--rc:${A}"><span class="icode__line-num">${k}</span>${o}</div>`}).join(""),R=a.map((_,v)=>{const k=(_.links||[]).map(N=>`<a href="${d(N.url)}" target="_blank" rel="noopener">→ ${d(N.label)}</a>`).join(" ");return`
    ...
    </div>`},"annotated-code"(t,e){const a=ae(t.code||""),n=we(t.code||""),s=(t.annotations||[]).map((r,p)=>`<li ${h(e.id,t.id,`annotations[${p}]`)}>${M(r)}</li>`).join("");return`${O(t,e,`slide--annotated-code slide--acode-${n}`)}
      <div class="slide__body">
        <div class="acode">
    ...
    </div>`},live(t,e){const a=(t.items||[]).map((n,s)=>`<li ${h(e.id,t.id,`items[${s}]`)}>${M(n)}</li>`).join("");return`${O(t,e,"slide--live")}
      <div class="slide__body">
        <div class="live">
...
self.stats["lifesteal"] = 0.0   # no apply change`,caption:"A new item, a difficulty nerf, a new mechanic — each is a line or two in a known place. That's not luck. You bought it with every &lsquo;data, not code&rsquo; decision upstream."},{id:"architecture",type:"concept",eyebrow:"Put it together",statement:"One picture, all of it.",diagram:'<div class="dg dg-center"><div class="dg-col dg-center" style="gap:var(--s-2); font-family:var(--font-mono); font-size:var(--fs-base); line-height:1.2;"><div>input <span class="dg-dim">&rarr;</span> <span class="dg-card" style="min-width:0; padding:6px 18px; display:inline-block;">context stack</span> <span class="dg-dim">&rarr;</span> ShopContext</div><div class="dg-flow__arrow">&darr;</div><div><span class="dg-accent">UPGRADES</span> <span class="dg-dim">(data)</span> <span class="dg-dim">&rarr;</span> draft(weighted) <span class="dg-dim">&rarr;</span> 3 cards</div><div class="dg-flow__arrow">&darr;</div><div>click <span class="dg-dim">&rarr;</span> apply_effect(<span class="dg-accent">effect</span>) <span class="dg-dim">&rarr;</span> player.stats</div><div class="dg-flow__arrow">&darr;</div><div><span class="dg-accent">curve constants</span> <span class="dg-dim">&rarr;</span> next level</div></div></div>',caption:"Every <b>box</b> is a machine you wrote once. Every <b>arrow</b> carries data you'll edit forever. Find the seam between them and your game stays soft."},{id:"sec-feel",type:"section",number:"10",kicker:"VI",title:"Feel, for free"},{id:"feel-framing",type:"concept",eyebrow:"The same move, one more time",statement:"Three two-line functions. Twenty uses each.",diagram:'<div class="dg dg-center"><div class="dg-card" style="min-width:1100px;"><div class="dg-card__title">the feel toolkit</div><div class="dg-card__rows"><div class="dg-card__row">lerp(a, b, t) <span class="dg-card__row__note">all smooth motion</span></div><div class="dg-card__row">ease(t) <span class="dg-card__row__note">the curve that makes it feel right</span></div><div class="dg-card__row">vary(v) <span class="dg-card__row__note">the wobble that makes it alive</span></div><div class="dg-card__row dg-card__row--accent">seasoning, not systems <span class="dg-card__row__note">no new mechanics</span></div></div></div></div>',caption:"Unit 9 met game feel as an idea. Here it's three functions — and it's the design-for-change move again: a tiny machine, reused everywhere, that you tune by a constant."},{id:"lerp",type:"code",language:"python",eyebrow:"The one function under all of it",heading:"lerp — walk from here to there",code:`def lerp(a, b, t):        # t walks 0.0 -> 1.0
    return a + (b - a) * t
